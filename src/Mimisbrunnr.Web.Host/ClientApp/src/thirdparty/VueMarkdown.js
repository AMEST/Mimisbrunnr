/*
    Base on https://github.com/miaolz123/vue-markdown with extended plugins
    =========================================
...
export default {
  ...
  render(createElement) {
    ...
    this.md.use(containerPlugin, "info");
    this.md.use(containerPlugin, "card");
    ...
    for(var i = 1; i <= 12; i++) {
      this.md.use(containerPlugin, "col-"+i);
      this.md.use(containerPlugin, "col-xs-"+i);
      this.md.use(containerPlugin, "col-sm-"+i);
